...
export class AWSDevOpsProjectStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    super(scope, id, props);

    const vpc = ec2.Vpc.fromVpcAttributes(this, 'ExistingVPC', {
      vpcId: 'vpc-0ec3eaf5e3b714e89',
      availabilityZones: ['ca-central-1a', 'ca-central-1b'],
      publicSubnetIds: ['subnet-0d4cc4dcd1ae2b192', 'subnet-0178d17f54c2e55e9'],
    ...
    const lt = new ec2.LaunchTemplate(this, 'EC2LaunchTemplate', {
      instanceType: ec2.InstanceType.of(ec2.InstanceClass.T3, ec2.InstanceSize.MICRO),
      machineImage: ec2.MachineImage.latestAmazonLinux({ generation: ec2.AmazonLinuxGeneration.AMAZON_LINUX_2023 }),
      securityGroup: ec2SG,
    });
